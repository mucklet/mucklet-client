...
/**
 * CharAreaModel creates a model with properties such as char, room, area, areaImage a model of child items of an area, including any hidden area/room
 * that the character is currently in.
 */
class CharAreaModel extends ModifyModel {

	/**
	 * Creates a new CharAreaModel instance.
