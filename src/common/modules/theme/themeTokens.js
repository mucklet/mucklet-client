...
const tokens = {
	...
	'log.mark.comm.fg': (getToken) => getToken('color.contrast.300'),
	'log.highlight.bg': (getToken) => getToken('surface.300.bg'),
	'log.highlight.fg': (getToken) => getToken('color.neutral.400'),
	'log.highlight.ooc.fg': (getToken) => getToken('color.neutral.300'),
	'log.highlight.comm.fg': (getToken) => getToken('color.neutral.700'),
	'log.highlight.mark.bg': (getToken) => getToken('surface.500.bg'),
