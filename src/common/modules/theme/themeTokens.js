...
const tokens = {
	...
	'control.default.bg': (getToken) => getToken('color.base.300'),
	'control.default.bg.hover': (getToken) => getToken('color.base.400'),
	...
	'control.raised.bg': (getToken) => getToken('color.base.400'),
	'control.raised.bg.hover': (getToken) => getToken('color.base.500'),
	...
	'status.danger.fg': (getToken) => getToken('color.danger.300'),
	...
	'log.cmd.ooc.fg': (getToken) => getToken('color.neutral.250'),
	...
	'log.active.fg': (getToken) => getToken('status.active.fg'),
	...
	'log.highlight.event.ooc.fg': (getToken) => getToken('color.neutral.250'),
