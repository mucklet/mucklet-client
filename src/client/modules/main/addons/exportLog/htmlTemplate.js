...
export const style = `
body { font-family: "Open Sans", sans-serif; font-size: 16px; color: #93969f; background-color: #161926; margin: 0; line-height: 1.4em; padding: 8px 16px; }
.cont {
	width: 100%;
	max-width: 720px;
	position: absolute;
...
.charlog--fieldset { position: relative; border: 1px solid #696d77; padding: 5px 10px; border-radius: 8px; }
.charlog--fieldset-label { color: #93969f; position: absolute; font-size: 12px; line-height: 10px; top: -6px; left: 16px; padding: 0 4px; background: #161926; }
.charlog--char { color: #6490a8; }
.charlog--default { color: #93969f; }
.charlog--strong { color: #fffcf2; }
.charlog--cmd { color: #c1a657; }
.charlog--error { color: #9a593e; }
.charlog--listitem { color: #6490a8; }
.charlog--ooc { color: #696d77; }
.charlog--comm { color: #bec0c5; }
.charlog--tag { font-size: 12px; color: #93969f; position: absolute; margin-left: -12px; margin-top: -12px; }
...
.common--formattext span.ooc { color: #696d77; }
...
// .charlog--code .opt::before, .charlog--code-inline .opt::before { content: "["; color: #696d77; }
// .charlog--code .opt::after, .charlog--code-inline .opt::after { content: "]"; color: #696d77; }
...
// .charlog--code .comment, .charlog--code-inline .comment { color: #93969f; }
// .charlog--code sup, .charlog--code-inline sup { font-size: 75%; line-height: 0; position: relative; top: -0.5em; }

export const defaultStyle = `white-space: pre-wrap; color: #bec0c5; padding: 6px 0 2px 0;`;
export const tagStyle = `white-space: pre-wrap; padding: 10px 0 2px 0;`;
export const labelStyle = `white-space: pre-wrap; padding: 10px 0 2px 0;`;
export const controlStyle = `font-size: 12px; padding: 9px 0 12px; line-height: 24px;`;
export const controlBorderStyle = `border-bottom: 1px solid #93969f;`;
export const describeStyle = `font-size: 12px; white-space: pre-wrap; padding: 6px 0 2px 0;`;
export const infoStyle = `color: #696d77; font-style: italic; padding-top: 4px;`;
...
export const helpmeFieldsetStyle = `border-color: #4a9fc3;`;
export const helpmeFieldsetLabelStyle = `color: #4a9fc3;`;
