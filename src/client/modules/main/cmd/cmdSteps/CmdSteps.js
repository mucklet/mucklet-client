...
class CmdSteps {
	...
	newInRoomCharStep(opt) {
		...
		return new IDStep(id, {
			name: defaultIDStepName,
			else: new ListStep(id, this.module.cmdLists.getInRoomChars(opt?.filterMuted), {
				name: defaultCharIdName,
	...
	newInRoomAwakeCharStep(opt) {
		...
		return new IDStep(id, {
			name: defaultIDStepName,
			else: new ListStep(id, this.module.cmdLists.getInRoomCharsAwake(opt?.filterMuted), {
				name: defaultCharIdName,
				errRequired: opt?.hasOwnProperty('errRequired') ? opt.errRequired : (step => errCharacterRequired),
				next,
				else: opt?.else,
	...
	newAwakeCharStep(opt) {
		...
		return new IDStep(id, {
			name: defaultIDStepName,
			else: new ListStep(id, this.module.cmdLists.getCharsAwake(opt?.filterMuted), {
				name: defaultCharIdName,
				errRequired: opt?.hasOwnProperty('errRequired') ? opt.errRequired : (step => errCharacterRequired),
				next,
				else: opt?.else,
	...
	newAnyCharStep(opt) {
		...
		return new IDStep(id, {
			...
			else: new ListStep(id, this.module.cmdLists.getAllChars(opt?.filterMuted), {
